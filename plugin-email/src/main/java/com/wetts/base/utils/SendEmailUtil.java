...
public class SendEmailUtil {
    ...
    static {
        ...
        HOST = PropertiesUtil.getProperty(path, "mail-config.properties", "host");
        PROTOCOL = PropertiesUtil.getProperty(path, "mail-config.properties", "protocol");
        PORT = PropertiesUtil.getProperty(path, "mail-config.properties", "not.ssl.port");
        SSL_PORT = PropertiesUtil.getProperty(path, "mail-config.properties", "ssl.port");
        FROM = PropertiesUtil.getProperty(path, "mail-config.properties", "from.address");
        FROM_NAME = PropertiesUtil.getProperty(path, "mail-config.properties", "from.name");
        PWD = PropertiesUtil.getProperty(path, "mail-config.properties", "from.pwd");
    }
