package com.wetts.persisitent.connection.examples.websocket;
...
public class WebsocketEndPoint {
    ...
    public void onError(@PathParam("relationId") String relationId,
                        ...
                        Throwable throwable,
                        Session session) {
        System.out.println("Websocket Connection Exception:" + SessionUtils.getKey(relationId, userCode));
    ...
    public void onClose(@PathParam("relationId") String relationId,
                        @PathParam("userCode") int userCode,
                        Session session) {
        System.out.println("Websocket Close Connection:" + SessionUtils.getKey(relationId, userCode));
        SessionUtils.remove(relationId, userCode);
    }
