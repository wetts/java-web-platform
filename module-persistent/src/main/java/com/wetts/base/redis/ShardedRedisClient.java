 ...
 * Sharded 是切片 
 * 根据你保存的Key实现了切分进行存储， 
 * 也就是说会分配到一台机器，而不是会复制到两台机器，
 * 当你再次获取key的时候，它会自动过分配到对应的机器获取Key的数据。
 * 
 * @author wetts
 * @create 2016年2月5日
 *
...
public class ShardedRedisClient {
	...
	private void StringOperate() {
		 ...
		 */
		System.out.println(
				"一次性新增key201,key202,key203,key204及其对应值：" + jedis.mset("key201", "value201", "key202", "value202", "key203", "value203", "key204", "value204"));
